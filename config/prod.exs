...
# ShopixWeb.Endpoint.load_from_system_env/1 dynamically.
...
ssl_database = if ({:system, "DATABASE_SSL"} || "true") == "true", do: true, else: false
...
#
#     config :shopix, Shopix.Web.Endpoint,
#       force_ssl: [hsts: true]
#
...
# start per endpoint:
#
#     config :shopix, ShopixWeb.Endpoint, server: true
#
