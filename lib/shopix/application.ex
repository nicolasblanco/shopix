defmodule Shopix.Application do
  use Application
  ...
  def start(_type, _args) do
    ...
    DeferredConfig.populate(:shopix)
    ...
    opts = [strategy: :one_for_one, name: Shopix.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    ShopixWeb.Endpoint.config_change(changed, removed)
    :ok
  end
end
